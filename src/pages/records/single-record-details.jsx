...
function SingleRecordDetails() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert diabeties and any disease diagnosis analyst. Use your knowledge base to answer questions about giving personalized recommended treatments.
